...
export class ApiResponseHelper {
  ...
  static created(type: Type<unknown> | Function | [Function] | string = ''): ApiResponseOptions {
    return { status: HttpStatus.CREATED, type, description: 'Successfully created' };
  }
  ...
  static validationError(errorMessage: string): ApiResponseOptions {
    ...
    return { status: HttpStatus.BAD_REQUEST, description: 'Validation error', schema: { example: schemaExample } };
  }
